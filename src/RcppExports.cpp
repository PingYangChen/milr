...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(getLogLikMilr(beta, y, X, bag));
    return __result;
END_RCPP
}
// getMilrProb
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::mat& >::type X(XSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type bag(bagSEXP);
    __result = Rcpp::wrap(getMilrProb(beta, X, bag));
    return __result;
END_RCPP
}
// getSoftmaxBag
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(getSoftmaxBag(X, beta, bag, alpha));
    return __result;
END_RCPP
}
// EM_Y
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(EM_Y(bagField, p_instance));
    return __result;
END_RCPP
}
// milr_cpp
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(milr_cpp(Z, X, bag, init_beta, lambda, tolerance, alpha, maxit));
    return __result;
END_RCPP
}
// softmaxlogL
